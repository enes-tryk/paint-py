...
#Declaring the colors using RGB codes
...
#Creating a white canvas with 800 600 resolution
...
#Setting the cursor to diamond (looks cool)
pygame.mouse.set_cursor(pygame.cursors.diamond)

#Drawing loop (I don't know what to comment down here)
while True:
    ...
    #Updates the program caption to information about the brush size, color and the brush shape        
    pygame.display.set_caption(f'paint-py - Brush Size: {brushSize} - Brush Color: {colorName} - Brush Shape: {brushName}')
